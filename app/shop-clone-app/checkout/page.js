...
export default function CheckoutPage() {
  ...
  const [status, setStatus] = useState("idle"); // idle | processing | declined | error
  ...
  async function pay(e) {
    ...
    try {
      ...
      // Charge succeeded — hold on to the receipt for the confirmation screen.
      receiptRef.current = { charge, order };
