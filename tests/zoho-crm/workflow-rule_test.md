...
## Open the flow
Go to https://my-testing-repo-main.vercel.app/zoho-crm/workflow-rule?reset=true and verify the text "Use case 32.2" and "Workflow rule trigger" are visible at the top of the page.

## Objective
Create a record that triggers a field update workflow.

## Key assertion
Verify: Field auto-updated per rule.
