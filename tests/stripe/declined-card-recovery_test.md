...
## Open the flow
Go to https://my-testing-repo-main.vercel.app/stripe/declined-card-recovery?reset=true and verify the text "Use case 9.3" and "Declined card recovery" are visible at the top of the page.

## Objective
Attempt payment with decline test card, then retry with valid card.

## Key assertion
Verify: Error surfaced inline and retry succeeds.
